...
<nav class="navbar navbar-expand-lg menu_one">
    <div class="<?php if ($singleland_header_layout == 'container') {
                    echo "container";
                } else {
                    echo "container-fluid";
                } ?>">
        <?php singleland_logo(); ?>
        <div class="collapse navbar-collapse <?php if ($singleland_menu_layout == 'center') {
                                                    echo "justify-content-center";
                                                } elseif ($singleland_menu_layout == 'start') {
